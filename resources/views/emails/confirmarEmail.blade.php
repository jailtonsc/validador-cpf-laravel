                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                    Confirme seu e-mail para ter acesso ao sistema.
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
                                                    <a href="{{route('users.confirmar', [$hash])}}" target="_blank"
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="100%" align="center" bgcolor="#f5f5f5"
                                                            ...
                                                            valign="top">
                                                            <a href="{{url('/')}}"
                                                               style="color: #428bca; text-decoration: none; background-color: transparent;">Wempregada &copy;
                                                                2015</a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
